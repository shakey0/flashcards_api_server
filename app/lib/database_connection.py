...
class DatabaseConnection:
    ...
    DEV_DATABASE_NAME = "flashcards_dev"
    TEST_DATABASE_NAME = "flashcards_test"
    ...
    def connect(self, provided_connection=None):
        ...
        if production:
            provided_connection = os.environ.get('DATABASE_URL')
        ...
        if testing_in_actions:
            ...
            print("Test database name:", self._database_name())
            connection_string = f"postgresql://postgres:postgres@localhost/{self._database_name()}"
        else:
            print("Local test/dev env")
